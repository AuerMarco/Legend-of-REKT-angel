...
/**
 * This class contains the logic for the dialogs and determines which NPC has
 * which dialog by having a method for every NPC / dialog
 *
 * @author Auer Marco
 */
public class Dialog implements Serializable {
    ...
    private boolean dialogVisible, dialogSpecial;
    ...
    public boolean getDialogSpecial() {
        return dialogSpecial;
    }

    public void setDialogSpecial(boolean special) {
...
//        dialogLogic();
    ...
    /**
     * Determines the dialog for the NPC Unknown Rogue. This one is a demo that
     * shows that a dialog can have multiple lines and multiple pages
     *
     * @param player The player character - the figure you control
     * @param npc the NPC whose dialog you will see upon interaction
     */
...
//        dialogLogicSpecial();
     ...
     * J while talking to an NPC If there is no next page, it closes the
     * dialogbox
     */
    ...
    public void dialogLogicSpecial() {
        if ((dialogCounter + 1) < dialogPage.length) {
            dialogLine1 = dialogPage[dialogCounter];
            dialogLine2 = dialogPage[dialogCounter + 1];
            dialogCounter += 2;
